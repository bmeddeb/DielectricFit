    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_schema', models.CharField(choices=[('dk_df', 'Dk/Df'), ('eps', 'Epsilon (ε′, ε″)')], default='dk_df', max_length=16)),
                ('input_freq_unit', models.CharField(default='GHz', max_length=16)),
                ('ingest_fingerprint', models.CharField(blank=True, max_length=64, null=True)),
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='datasets', to='people.project')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fitting_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='curves', to='dielectric.fittingsession')),
            ],
        ),
        migrations.CreateModel(
            name='Artifact',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('fitting_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='artifacts', to='dielectric.fittingsession')),
            ],
        ),
        migrations.CreateModel(
            name='ModelConfig',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('analysis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='model_configs', to='dielectric.analysis')),
                ('model_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='configs', to='dielectric.modeltype')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameters', to='dielectric.modelconfig')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preprocessing_configs', to='dielectric.dataset')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preprocessing_config', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='points', to='dielectric.preprocessingconfig')),
            ],
        ),
        migrations.AddField(
            model_name='fittingsession',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('epsilon_imag', models.FloatField(blank=True, null=True)),
                ('tan_delta', models.FloatField(blank=True, null=True)),
                ('dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='raw_points', to='dielectric.dataset')),
            ],
        ),
        migrations.CreateModel(
            name='Share',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('analysis', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='shares', to='dielectric.analysis')),
                ('fitting_session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='shares', to='dielectric.fittingsession')),
            ],
        ),
        migrations.AddIndex(
            model_name='dataset',
